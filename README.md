About sphinxcontrib-versioning-feedstock
========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinxcontrib-versioning-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/Robpol86/sphinxcontrib-versioning
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3576&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxcontrib-versioning-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-versioning` can be installed with `conda`:
...
```
mamba install sphinxcontrib-versioning
```

It is possible to list all of the versions of `sphinxcontrib-versioning` available on your platform with `conda`:
...
```
mamba search sphinxcontrib-versioning --channel conda-forge
```
...
mamba repoquery search sphinxcontrib-versioning --channel conda-forge

# List packages depending on `sphinxcontrib-versioning`:
mamba repoquery whoneeds sphinxcontrib-versioning --channel conda-forge

# List dependencies of `sphinxcontrib-versioning`:
mamba repoquery depends sphinxcontrib-versioning --channel conda-forge
```
